    ...
    <div className="flex flex-col gap-4 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        <div className="bg-[#EAEAEA] dark:bg-[#1A1A1A] rounded p-3 border border-[#D1D1D1] dark:border-[#2A2A2A] shadow-sm">
          <h2 className="font-extrabold text-xs uppercase mb-2 tracking-wide border-b border-[#D1D1D1] dark:border-[#4D4D4D] pb-1 text-[#171717] dark:text-white bg-white dark:bg-[#111]">{t('aof.klient')}</h2>
          <div className="flex gap-2">
        ...
        {/* PARTNER */}
        <div className="bg-[#EAEAEA] dark:bg-[#1A1A1A] rounded p-3 border border-[#D1D1D1] dark:border-[#2A2A2A] shadow-sm">
          <div className="flex items-center gap-2 mb-2 border-b border-[#D1D1D1] dark:border-[#4D4D4D] pb-1 cursor-pointer bg-white dark:bg-[#111]" onClick={() => setHasPartner(!hasPartner)}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-[#EAEAEA] dark:bg-[#1A1A1A] rounded p-4 border border-[#D1D1D1] dark:border-[#2A2A2A] shadow-sm text-xs">
          <h2 className="font-extrabold text-sm uppercase tracking-wide border-b border-[#D1D1D1] dark:border-[#4D4D4D] pb-1 mb-2 bg-white dark:bg-[#111]">{t('aof.cashflow')}</h2>
          ...
          <div className="flex justify-between items-center font-bold pb-2 pt-2 border-t border-[#D1D1D1] dark:border-[#4D4D4D] bg-white dark:bg-[#111]">
        ...
        <div className="flex flex-col gap-4">
           ...
           <div className="bg-[#EAEAEA] dark:bg-[#1A1A1A] rounded p-4 border border-[#D1D1D1] dark:border-[#2A2A2A] shadow-sm text-xs font-bold">
             <h2 className="font-extrabold text-sm uppercase tracking-wide border-b border-[#D1D1D1] dark:border-[#4D4D4D] pb-1 mb-2 bg-white dark:bg-[#111]">{t('aof.mesacnyCashflowTitle')}</h2>
             ...
             <h2 className="font-extrabold text-sm uppercase tracking-wide border-b border-[#D1D1D1] dark:border-[#4D4D4D] pb-1 mt-4 mb-2 bg-white dark:bg-[#111]">{t('aof.majetokTitle')}</h2>
             ...
             <div className="flex justify-between py-2 mt-2 border-t border-[#D1D1D1] dark:border-[#4D4D4D] text-sm font-extrabold bg-white dark:bg-[#111]"><span>{t('aof.cistaHodnota')}</span> <span className="bg-white dark:bg-[#333] px-2 border">{cistaHodnota.toFixed(0)} €</span></div>
           </div>
           ...
           <div className="bg-[#EAEAEA] dark:bg-[#1A1A1A] rounded p-4 border border-[#D1D1D1] dark:border-[#2A2A2A] shadow-sm text-xs relative flex flex-col xl:flex-row gap-6">
             ...
             <div className="flex-[1.5] flex flex-col justify-center">
               <h2 className="font-extrabold text-sm uppercase tracking-wide border-b border-[#D1D1D1] dark:border-[#4D4D4D] pb-1 mb-2 bg-white dark:bg-[#111]">{t('aof.idealneMiery')}</h2>
               ...
               <div className="space-y-1">
                 <div className="grid grid-cols-4 items-center bg-white dark:bg-[#333] border p-1 rounded font-bold">
                   <div className="flex items-center gap-1"><span className="border text-[9px] px-0.5 bg-white dark:bg-[#111]" style={{borderColor:'#1E5083'}}>40%</span> {t('aof.spotrebaSpolu').replace('Spolu ', '')}</div>
                 ...
                 <div className="grid grid-cols-4 items-center bg-white dark:bg-[#333] border p-1 rounded font-bold">
                   <div className="flex items-center gap-1"><span className="border text-[9px] px-0.5 bg-white dark:bg-[#111]" style={{borderColor:'#E06138'}}>30%</span> {t('aof.uveroveSpolu').replace('Spolu ', '')}</div>
                 ...
                 <div className="grid grid-cols-4 items-center bg-white dark:bg-[#333] border p-1 rounded font-bold">
                   <div className="flex items-center gap-1"><span className="border text-[9px] px-0.5 bg-white dark:bg-[#111]" style={{borderColor:'#166E36'}}>20%</span> {t('aof.tvorbaSpolu').replace('Spolu ', '')}</div>
                 ...
                 <div className="grid grid-cols-4 items-center bg-white dark:bg-[#333] border p-1 rounded font-bold">
                   <div className="flex items-center gap-1"><span className="border text-[9px] px-0.5 bg-white dark:bg-[#111]" style={{borderColor:'#009EDC'}}>10%</span> Rezerva</div>
      ...
      <div className="mt-8 flex flex-col gap-4 text-xs">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
           ...
           <div className="flex flex-col gap-2">
              ...
              <div className="bg-[#EAEAEA] dark:bg-[#1A1A1A] p-2 rounded shadow-sm border border-[#D1D1D1] dark:border-[#333]">
                ...
                <div className="grid grid-cols-3 items-center mb-1"><div className="font-bold">{t('aof.produkcnyKapital')}</div><input type="text" readOnly value={vypocitanyProdukcnyKapitalKlient > 0 ? `${vypocitanyProdukcnyKapitalKlient.toFixed(0)} €` : ''} className="border mx-1 px-1 text-center bg-[#D6D6D6] dark:bg-[#333] cursor-not-allowed text-[#555] dark:text-[#AAA]" /><input type="text" readOnly value={vypocitanyProdukcnyKapitalPartner > 0 ? `${vypocitanyProdukcnyKapitalPartner.toFixed(0)} €` : ''} className="border mx-1 px-1 text-center bg-[#D6D6D6] dark:bg-[#333] cursor-not-allowed text-[#555] dark:text-[#AAA]" /></div>
                <div className="grid grid-cols-3 items-center mb-1"><div className="font-bold">{t('aof.renta')}</div><input value={aofCiele.zabezpecenieKlientRenta} onChange={e=>setAofCiele({zabezpecenieKlientRenta: Number(e.target.value)})} className="border mx-1 px-1 text-center bg-white dark:bg-[#111]" /><input value={aofCiele.zabezpeceniePartnerRenta} onChange={e=>setAofCiele({zabezpeceniePartnerRenta: Number(e.target.value)})} className="border mx-1 px-1 text-center bg-white dark:bg-[#111]" /></div>
                ...
                <div className="flex items-center gap-2 mt-3 pt-2 border-t border-[#D1D1D1] dark:border-[#333] bg-white dark:bg-[#111]">
           ...
           <div className="bg-[#EAEAEA] dark:bg-[#1A1A1A] p-2 rounded shadow-sm border border-[#D1D1D1] dark:border-[#333] h-min">
              <div className="grid grid-cols-4 font-extrabold mb-2 pb-1 border-b border-[#D1D1D1] dark:border-[#333] bg-white dark:bg-[#111]">
        ...
        <div className="bg-[#EAEAEA] dark:bg-[#1A1A1A] p-4 rounded shadow-sm border border-[#D1D1D1] dark:border-[#333]">
           {/* Byvanie */}
           <div className="flex items-start gap-4 mb-4 pb-4 border-b border-[#D1D1D1] dark:border-[#333] bg-white dark:bg-[#111]">
           ...
           <div className="flex items-center gap-4 mb-4 pb-4 border-b border-[#D1D1D1] dark:border-[#333] bg-white dark:bg-[#111]">
